...
Use `dv work {{ task.id }} show --json` as the authoritative work item model. Use this prompt only as a rendered view of that JSON.
...
3. Record evidence with `dv work {{ task.id }} record --claim` after validation passes.
