---
title: User Personas template
source: https://www.thegooddocsproject.dev/template/user-personas
intent: Create user personas that effectively capture the users' needs
category: reference
docType: template
docSubType: persona
...
subtype: template
links:
  - related: "[[process-user-personas]]"
  - related: "[[guide-user-personas]]"
  - related: "[[resources-user-personas]]"
---
...
- For step-by-step guidance on creating user personas, explore our [[process-user-personas|User personas process]].

- To see examples and explanations about how to fill in this template, explore the [[guide-user-personas|guide]].

- To read more from the sources that inspired and shaped our documents on user personas, explore our [[resources-user-personas|User personas resources]].

## {Optional: Visual representation of first user persona}

## {Name or type of first user persona}

{Use the [[process-user-personas|Process guide]] to help inform your selection process for the dimension and attributes. Choose the most important item from the following options for the dimension and remove it from the list. Keep the most relevant items as user persona attributes and eliminate unnecessary items for your project.}
...
{Use the [[process-user-personas.md|User personas process]] to help inform your selection process for the dimension and attributes. Choose the most important item from the following options for the dimension and remove it from the list. Keep the most relevant items as user persona attributes and eliminate unnecessary items for your project.}
