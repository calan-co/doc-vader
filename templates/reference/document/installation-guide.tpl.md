...
source: <https://www.thegooddocsproject.dev/template/installation-guide>
intent: Guide users through a series of steps to install the product and set it up for further use.
category: how-to
docType: template
docSubType: installation
...
> If you need more information about how to fill in this template, read the accompanying [[guide-installation-guide.md|guide]].
>
...
2. Download the update at [see details](http://example.com).
