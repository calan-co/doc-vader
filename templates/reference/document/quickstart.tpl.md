...
title: {Product} Quickstart Guide
source: <https://www.thegooddocsproject.dev/template/quickstart>
intent: Introduces first time users to the application.
It focuses on the primary feature of the application and helps users start using the application as quickly as possible.
category: tutorial
docType: template
docSubType: quickstart
...
> If you need more information about how to fill in this template, read the accompanying [[guide-quickstart.md|guide]].
>
