...
summary: <Brief summary of the bug's scope and impact>
...
links:
  - type: related
    target: "[[<artifact_work-item_or_document>]]"
    note: <optional explanation of the relationship>
priority: <Assign priority according to context and impact>
