...
description: |
  Implement ConfigLoader class with extends resolution, circular dependency detection,
  and TypeBox schema validation. Uses AJV directly (already a dependency) for validation.
