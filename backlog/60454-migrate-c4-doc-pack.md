...
id: wi-60454
title: Migrate C4 Doc-Pack
summary: Migrate the c4 domain into a self-contained doc-pack.
type: work-item
subtype: story
lifecycle: active
status: ready
...
Migrate `c4` as an independently validated Phase 4 doc-pack.

## Background

This pack owns C4 architecture-model documentation. It follows accepted registry and pack-conformance
patterns without redesigning their interfaces.

## Tasks

- [ ] Confirm the Phase 1 inventory scope for `c4`.
...
- A `c4` pack with pack-local fixtures and tests.
