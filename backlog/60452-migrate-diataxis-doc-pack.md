...
id: wi-60452
title: Migrate DIATAXIS Doc-Pack
summary: Migrate the diataxis domain into a self-contained doc-pack.
type: work-item
subtype: story
lifecycle: active
status: ready
...
Migrate `diataxis` as an independently validated Phase 4 doc-pack.

## Background

This pack owns tutorial, how-to, reference, and explanation artifacts. It follows accepted registry and pack-conformance
patterns without redesigning their interfaces.

## Tasks

- [ ] Confirm the Phase 1 inventory scope for `diataxis`.
...
- A `diataxis` pack with pack-local fixtures and tests.
