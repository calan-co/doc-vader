...
id: wi-60455
title: Migrate RFX Doc-Pack
summary: Migrate the rfx domain into a self-contained doc-pack.
type: work-item
subtype: story
lifecycle: active
status: ready
...
Migrate `rfx` as an independently validated Phase 4 doc-pack.

## Background

This pack owns RFI, RFP, and RFQ artifacts. It follows accepted registry and pack-conformance
patterns without redesigning their interfaces.

## Tasks

- [ ] Confirm the Phase 1 inventory scope for `rfx`.
...
- A `rfx` pack with pack-local fixtures and tests.
