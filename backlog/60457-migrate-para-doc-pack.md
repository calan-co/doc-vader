...
id: wi-60457
title: Migrate PARA Doc-Pack
summary: Migrate the para domain into a self-contained doc-pack.
type: work-item
subtype: story
lifecycle: active
status: ready
...
Migrate `para` as an independently validated Phase 4 doc-pack.

## Background

This pack owns PARA organization artifacts. It follows accepted registry and pack-conformance
patterns without redesigning their interfaces.

## Tasks

- [ ] Confirm the Phase 1 inventory scope for `para`.
...
- A `para` pack with pack-local fixtures and tests.
