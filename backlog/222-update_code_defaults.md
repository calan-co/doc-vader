...
description: |
Update hardcoded schema paths in code from old structure
(schemas/frontmatter/document/) to new canonical structure
(schemas/frontmatter/by-type/document/). Affects ~8 files.
