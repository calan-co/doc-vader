...
checked in as committed convenience copies for local Sandcastle runs. Treat
the initialization templates as the source of truth and regenerate the
`.sandcastle` artifacts instead of hand-editing prompt outputs.
