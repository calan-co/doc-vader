...
title: {Project} Contributing Guide
source: <https://www.thegooddocsproject.dev/template/how-to>
intent: Communicate the process for contributing, including standards, structure and procedures
category: how-to
docType: template
docSubType: contributing
...
> If you need more information about how to fill in this template, read the accompanying [guide](../../../source-files/guide-contributing-guide.md).
>
