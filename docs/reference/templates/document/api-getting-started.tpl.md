...
title: {Product} API getting started guide
source: <https://www.thegooddocsproject.dev/template/api-getting-started>
intent: Walks users through creating a minimum working example with your API
category: tutorial
docType: template
docSubType: guide
