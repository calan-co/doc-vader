...
source: <https://www.thegooddocsproject.dev/template/changelog>
intent: Records all significant and noteworthy modifications made during each release, in reverse-chronological order.
category: reference
docType: template
