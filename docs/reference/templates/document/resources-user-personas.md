...
- To fill out your user characteristics into a structured template, explore the [[user-personas.tpl|User persona template]].

- To see examples and explanations about how to fill in the User personas template, explore the [[guide-user-personas|User persona template guide]].
